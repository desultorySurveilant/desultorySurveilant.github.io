...
dY:function(a,b){return J.cW(a).U(a,b)},
...
if(l!=null)$.o=l
g=u.b
if(!!J.v(g).$ian){if(g.a>=4){k=H.h(q.c,"$iN")
q.c=null
b=q.J(k)
q.a=g.a
q.c=g.c
...
C.c.i($.O,a)
try{t=u
t.a=P.dc(t.a,a,", ")}finally{if(0>=$.O.length)return H.f($.O,-1)
$.O.pop()}u.a+=c
t=u.a
return t.charCodeAt(0)==0?t:t},
...
eT:function(){var u,t,s,r,q,p,o="#colorInput",n="#layerInput",m="#paletteLength",l="#layerLength",k=document,j=H.I(k.querySelector("#loadString"),"$il").value
P.a4(j)
j=F.f_(j)
P.a4(j)
H.I(k.querySelector("#name"),"$il").value=C.a.w(j,0,J.cW(j).ap(j,":"))
H.I(k.querySelector("#labelPlate"),"$il").value=":___"
u=j.split(":___")
...
u=new DataView(u,0)
t.a=u
H.I(k.querySelector("#type"),"$il").value=C.b.h(t.B())
H.I(k.querySelector(m),"$il").value=C.b.h(t.B())
J.a6(k.querySelector(o)).S(0)
s=0
while(!0){u=P.z(H.I(k.querySelector(m),"$il").value)
...
u=t.L(8)
q="#"+(F.aD(u/16|0)+F.aD(C.b.H(u,16)))
u=t.L(8)
q+=F.aD(u/16|0)+F.aD(C.b.H(u,16))
u=t.L(8)
r.value=q+(F.aD(u/16|0)+F.aD(C.b.H(u,16)))
J.a6(k.querySelector(o)).i(0,r);++s}H.I(k.querySelector(l),"$il").value=C.b.h(t.B())
J.a6(k.querySelector(n)).S(0)
s=0
while(!0){u=P.z(H.I(k.querySelector(l),"$il").value)
if(typeof u!=="number")return H.a3(u)
if(!(s<u))break
p=W.D(null)
p.type="number"
...
p.value=C.b.h(t.B())
J.a6(k.querySelector(n)).i(0,p);++s}H.I(k.querySelector("#rotation"),"$il").value=C.b.h(t.B())
H.I(k.querySelector("#orientation"),"$il").value=C.b.h(t.B())},
du:function(){var u,t,s=null,r=new B.bb(new P.at("")),q=document,p=H.h(q.querySelector("#name"),"$il"),o=H.h(q.querySelector("#labelPlate"),"$il")
r.A(P.z(H.h(q.querySelector("#type"),"$il").value))
r.A(P.z(H.h(q.querySelector("#paletteLength"),"$il").value))
for(u=J.a6(q.querySelector("#colorInput")),u=u.gp(u);u.k();)r.a4(F.eL(J.dY(H.h(u.d,"$il").value,1)),24)
r.A(P.z(H.h(q.querySelector("#layerLength"),"$il").value))
for(u=J.a6(q.querySelector("#layerInput")),u=u.gp(u);u.k();)r.A(P.z(H.h(u.d,"$il").value))
r.A(P.z(H.h(q.querySelector("#rotation"),"$il").value))
r.A(P.z(H.h(q.querySelector("#orientation"),"$il").value))
...
W.aY.prototype={}
P.bh.prototype={
gP:function(){var u=this.b,t=H.eJ(u,"x",0),s=W.t
...
S:function(a){J.d1(this.b.a)},
gj:function(a){return J.aE(this.gP().a)},
u:function(a,b){var u=this.gP()
return u.b.$1(J.d2(u.a,b))},
gp:function(a){var u=P.e6(this.gP(),!1,W.t)
return new J.ai(u,u.length,[H.w(u,0)])},
$ax:function(){return[W.t]},
$an:function(){return[W.t]},
$aj:function(){return[W.t]}}
P.bi.prototype={
$1:function(a){return!!J.v(H.h(a,"$ik")).$it},
$S:13}
P.bj.prototype={
$1:function(a){return H.I(H.h(a,"$ik"),"$it")},
$S:14}
P.ce.prototype={
